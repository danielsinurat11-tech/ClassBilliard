...
<!-- SUCCESS MESSAGE -->
<div id="successMessage" class="mt-8 hidden p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-lg flex items-start gap-4 animate-in fade-in slide-in-from-top-4 duration-300">
...
<!-- ERROR MESSAGE -->
<div id="errorMessage" class="mt-8 hidden p-4 bg-red-500/10 border border-red-500/30 rounded-lg flex items-start gap-4 animate-in fade-in slide-in-from-top-4 duration-300">
    ...
    document.getElementById('permissionsForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.success) {
                ...
                // After success, reload page after 2 seconds to ensure all caches cleared
                setTimeout(() => {
