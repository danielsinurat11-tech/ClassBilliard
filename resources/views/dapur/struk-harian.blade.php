...
<head>
    ...
    <title>Struk Tutup Hari - {{ $tanggal->format('d M Y') }}@if($shift) - {{ $shift->name }}@endif</title>
    <style>
        @media print {
            @page {
                size: A4;
        ...
        * {
        ...
        .print-button {
            ...
            border: none;
            cursor: pointer;
            box-shadow: 0 4px 15px rgba(250, 154, 8, 0.4);
            display: flex;
            align-items: center;
            gap: 10px;
            transition: all 0.3s;
        ...
        .print-button:hover {
            ...
            box-shadow: 0 6px 20px rgba(250, 154, 8, 0.6);
        }
    ...
    <div class="struk-container">
        ...
        <div class="header">
            ...
            <div class="transaction-number">
                No. {{ $tanggal->format('Ymd') }}-{{ str_pad($totalOrder, 3, '0', STR_PAD_LEFT) }}
            </div>
        </div>
        ...
        <div class="info-row">
            <span>Shift :</span>
            <span>{{ $shift->name }} ({{ $shift->start_time }} - {{ $shift->end_time }} WIB)</span>
        </div>
        @endif
        <div class="info-row">
            <span>Kasir :</span>
        ...
        <div class="summary-section">
            <div class="summary-row">
                <span>Total QTY :</span>
                <span>{{ $orders->sum(function($order) { return $order->orderItems->sum('quantity'); }) }}</span>
            </div>
            <div class="summary-row">
        ...
        <div class="footer">
            ...
            <div>
                <img src="{{ asset('barcode.png') }}" alt="Barcode" class="barcode" onerror="this.style.display='none'">
            </div>
        </div>
