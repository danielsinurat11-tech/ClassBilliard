            ...
            <div class="find-food-section" id="menuSection">
                ...
                <div class="menu-item-card" data-category="makanan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/MIE GORENG CLASS - 25K 2.png') }}" alt="Mie Goreng Class" class="menu-item-image">
                    </div>
                ...
                <div class="menu-item-card" data-category="makanan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/MIE KUAH CLASS - 25K 2.png') }}" alt="Mie Kuah Class" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="makanan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/NASI GORENG CLASS - 30K 2.png') }}" alt="Nasi Goreng Class" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="makanan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/NASI TELUR CLASS - 30K 2.png') }}" alt="Nasi Telur Class" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="makanan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/BEEF RICE BOWL - 45K 2.png') }}" alt="Beef Rice Bowl" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/MIX PLATER - 45K 2.png') }}" alt="Mix Plater" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Mix Plater</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/AIR MINERAL - 10K 2.png') }}" alt="Air Mineral" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Air Mineral</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/AMERICANO ICED -25K 2.png') }}" alt="Americano Iced" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/BLACK COFFE - 10K 2.png') }}" alt="Black Coffee" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Black Coffee</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/CHOCOLATE MILK - 20K 2.png') }}" alt="Chocolate Milk" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/EXTRAJOS SUSU - 18K 2.png') }}" alt="Extrajos Susu" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Extrajos Susu</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/KOPI SUSU CLASS - 23K 2.png') }}" alt="Kopi Susu Class" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/KUKUBIMA SUSU - 18K 2.png') }}" alt="Kukubima Susu" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Kukubima Susu</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/LEMON TEA - 25K 2.png') }}" alt="Lemon Tea" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Lemon Tea</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/LYCHEE TEA - 25K 2.png') }}" alt="Lychee Tea" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Lychee Tea</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/MATCHA LATTE - 25K 2.png') }}" alt="Matcha Latte" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Matcha Latte</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/MILK BASIC - 18K 2.png') }}" alt="Milk Basic" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Milk Basic</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/NUTRISARI ORANGE - 10K 2.png') }}" alt="Nutrisari Orange" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/ICED TEA BASIC - 15K 2.png') }}" alt="Tea Basic" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Tea Basic</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/TEA TARIK - 25K 2.png') }}" alt="Tea Tarik" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Tea Tarik</h3>
                ...
                <div class="menu-item-card" data-category="minuman">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/YAKULT ORANGE - 25K 2.png') }}" alt="Yakult Orange" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Yakult Orange</h3>
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/KENTANG BALADO - 25K 2.png') }}" alt="Kentang Balado" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/SINGKONG GORENG - 20K 2.png') }}" alt="Singkong Goreng" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/SOSIS GORENG - 25K 2.png') }}" alt="Sosis Goreng" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Sosis Goreng</h3>
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/TAHU KRISPI - 20K 2.png') }}" alt="Tahu Krispi" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Tahu Krispi</h3>
                ...
                <div class="menu-item-card" data-category="cemilan">
                    <div class="menu-item-image-wrapper">
                        <img src="{{ asset('assets/img/TAHU WALIK - 20K 2.png') }}" alt="Tahu Walik" class="menu-item-image">
                    </div>
                    <div class="menu-item-info">
                        <div class="menu-item-header">
                            <h3>Tahu Walik</h3>
